...
function Login() {
  ...
  return (
    <div className="font-roboto">
      ...
      <h2 className={`text-4xl font-semibold mb-6 font-roboto transition-colors duration-200 ${
      ...
      <form className="space-y-4" onSubmit={loginUser}>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <input
              id="remember"
              type="checkbox"
              className={`w-4 h-4 mr-2 rounded border-2 transition-colors duration-200 ${
                theme === 'dark'
          ...
          <Link
            to="/"
            className={`text-sm font-semibold no-underline link-underline transition-colors duration-200 ${
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full p-2 mt-2 font-bold text-white cursor-pointer rounded-lg
      ...
      <p className={`text-sm mt-7 mb-7 text-center transition-colors duration-200 ${
        theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
      }`}>
        ¿No tienes una cuenta?
        <Link
          to="/auth/register"
          className={`ml-1 font-bold no-underline link-underline transition-colors duration-200 ${
            theme === 'dark' ? 'text-slate-400 hover:text-slate-300' : 'text-slate-600 hover:text-slate-700'
          }`}
        >
          Registrarme
