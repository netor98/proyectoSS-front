...
function Register() {
	...
	const labelClassName = `block text-sm font-medium transition-colors duration-200 ${
	...
	return (
		...
		<div className="font-roboto">
			...
			<p className={`text-sm mt-7 text-center transition-colors duration-200 ${
				theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
			}`}>
				¿Ya tienes una cuenta?
				<Link
					to="/auth/login"
					className={`ml-1 cursor-pointer font-bold no-underline link-underline transition-colors duration-200 ${
